...
SELECT
    ...
    CASE
        ...
        WHEN days_late BETWEEN 8 AND 30 THEN '8-30 Days Late'
        WHEN days_late BETWEEN 31 AND 60 THEN '31-60 Days Late'
        ELSE '61+ Days Late'
...
--26. High Outstanding + Late Payments
SELECT
    l.loan_id,
    l.customer_id,
    l.loan_type,
...
SELECT
    ...
    ROUND(
        late_payment_count * 100.0 /
        NULLIF(payment_count, 0),
        2
    ) AS late_payment_rate
...
SELECT
    ...
    CASE
        WHEN late_payment_count >= 5
             AND maximum_days_late >= 30
...
--SECTION K Regional Exposure + Payment Risk
